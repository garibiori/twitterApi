...
print(twitter_api)
print()
input('Press Enter to see Example 2')
print()
...
print(us_trends)
print()
input("Press Enter to see Example 3 ")
print()
print("---------------------------------------------------------------------")
...
print()
print()
input("Press Enter to see US trends ")
print()
print('US trends with json.dumps')
print(json.dumps(us_trends, indent=1))
print()
input("Press Enter to see Example 4 ")
print()
print("---------------------------------------------------------------------")
...
print()
input("Press Enter to see Example 5 ")
print()
...
print()
input("Press Enter to see Example 6 ")
print()
print("---------------------------------------------------------------------")
...
print()
input("Press Enter to see Example 7 ")
print()
print("---------------------------------------------------------------------")
...
print()
input("Press Enter to see Example 8 ")
print()
print("---------------------------------------------------------------------")
...
print()
input("Press Enter to see Example 9 ")
print()
